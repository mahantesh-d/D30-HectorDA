...
def run():
	...
	# req = d20_pb2.Request(ApplicationName="alltrade", ApplicationMethod="stock_adjustment", Method=d20_pb2.RESTMethod.Value("POST"), ApplicationPayload='{"adjust_datetime" : "", "adjust_status": "status"}')
	print req
        execute(stub,req)
