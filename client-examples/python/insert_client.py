...
def run():
	...
	req = d20_pb2.Request(ApplicationName="alltrade", ApplicationMethod="foobar", Method=d20_pb2.RESTMethod.Value("POST"), ApplicationPayload='{"email_id" : ["abc@email.com","abcd@email.com"], "adjust_status": "status"}')
	print req
        execute(stub,req)
